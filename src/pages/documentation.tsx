          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="md:flex md:justify-between" data-sticky-container>
                {/* Sidebar */}
                <aside className="sticky top-20 my-12 h-screen md:my-0 md:mr-12 md:w-64 md:shrink-0 lg:mr-20">
                  <div
                    className="mt-3"
                    data-sticky
                    data-sticky-for="768"
                    ...
                    <nav className={`md:block ${!sidebarNavOpen && "hidden"}`}>
                      <ul className="-my-2 font-medium">
                        ...
                        <li className="py-2">
                          ...
                          {/* 2nd level */}
                          <ul
                            className={`-mb-1 mt-1 ml-2 border-l border-gray-300 pl-5 font-normal ${
                        ...
                        <li className="py-2">
                          <a
                            className="flex items-center hover:underline"
                            href="https://github.com/orgs/gipplab/projects/8"
                            target="_blank"
