        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-16">
            <h1 className="h2 mb-4">
              ...
              supercharges research projects
            </h1>
            <p className="text-xl text-gray-600">
              Researchers worldwide rely on CS-Insights to get the most out of
              their projects. The most revolutionary way of visualizing and
          ...
          <div className="flex flex-col items-center pt-12 md:pt-16">
            <div className="relative">
              ...
              />
              <Image
                className="animation-delay-1000 absolute max-w-full transform animate-float"
                src={PlanetAvatar02}
                width="355"
                height="173"
